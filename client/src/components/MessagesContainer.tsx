...
state.newSocket.on('msg-recieve',(data)=>{
  dispatch({type:'NEW_MESSAGE',payload:{id:Date.now(),message:data.message,createdAt:Date.now(),type:'text'}})
...
if(allMessages.length===0)return <div className="h-full flex items-center justify-center">No messages</div>
